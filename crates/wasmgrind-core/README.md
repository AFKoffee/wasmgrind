...
## Attributions
Initially, this library used as its instrumentation engine. While we moved to [walrus](https://github.com/wasm-bindgen/walrus) because its more actively maintained and supports bleeding-edge WebAssembly features, the new walrus-based implementation is still heavily inspired by the original [Wasabi](https://github.com/danleh/wasabi) project.
